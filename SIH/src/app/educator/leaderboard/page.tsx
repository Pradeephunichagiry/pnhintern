...
export default function EducatorLeaderboardPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold font-headline">Educator Leaderboard</h1>
          <p className="text-muted-foreground">See how your students are performing!</p>
        </div>
      </div>
